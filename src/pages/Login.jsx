  ...
  return (
    ...
    >
      <div className="max-w-md w-full">
        <div className="flex gap-2 mb-6 bg-white/90 backdrop-blur-sm rounded-lg p-1 border border-gray-100">
          <button
            onClick={() => setLoginMethod("password")}
            className={`flex-1 py-2 px-4 rounded-md font-medium transition-all ${
              loginMethod === "password" ? "bg-blue-600 text-white" : "text-gray-600 hover:text-gray-900"
            }`}
          >
            Password
          </button>
          <button
            ...
            className={`flex-1 py-2 px-4 rounded-md font-medium transition-all ${
              loginMethod === "biometric" ? "bg-blue-600 text-white" : "text-gray-600 hover:text-gray-900"
            }`}
          >
            Fingerprint
          </button>

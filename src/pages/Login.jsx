...
import { Eye, EyeOff, Mail, Lock, LogIn, User, HelpCircle, Fingerprint } from "lucide-react"
...
export default function Login() {
  ...
  const handleFingerprintSuccess = (token, user) => {
    setAuthToken(token)
    login(token, user)
      ...
      <div className="max-w-md w-full">
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-gray-100">
          {!showFingerprintLogin ? (
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full flex justify-center items-center gap-2 py-3 px-4 border border-green-300 text-sm font-medium rounded-lg text-green-700 bg-green-50 hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200"
                >
            ...
            <FingerprintLogin
              email={form.email}
              onBack={() => setShowFingerprintLogin(false)}
